...
export const OfferPage = () => {
  ...
  const hoveredOffer = useMemo(() => nearestOffers.find((offer) => offer.id === hoveredOfferId), [hoveredOfferId]);

  // TODO: запрос на бек за данными для офера по айдишнику, это удалить
  const offerData = useMemo(() => nearestOffers.find((offer) => offer.id === id) ?? nearestOffers[0], [id]);
